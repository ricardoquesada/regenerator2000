...
pub fn handle_input(
    ...
    match key.code {
        ...
        KeyCode::Char('c') if key.modifiers.is_empty() => InputResult::Action(MenuAction::Code),
        KeyCode::Char('b') if key.modifiers.is_empty() => InputResult::Action(MenuAction::Byte),
        KeyCode::Char('w') if key.modifiers.is_empty() => InputResult::Action(MenuAction::Word),
        KeyCode::Char('a') if key.modifiers.is_empty() => InputResult::Action(MenuAction::Address),
        KeyCode::Char('t') if key.modifiers.is_empty() => InputResult::Action(MenuAction::Text),
        KeyCode::Char('s') if key.modifiers.is_empty() => {
            InputResult::Action(MenuAction::Screencode)
        }
        KeyCode::Char('?')
            if !key
                .modifiers
        ...
        {
            InputResult::Action(MenuAction::Undefined)
        }
        KeyCode::Char('<')
            if !key
                .modifiers
                .intersects(KeyModifiers::CONTROL | KeyModifiers::ALT) =>
        {
            InputResult::Action(MenuAction::SetLoHi)
        }
        KeyCode::Char('>')
            if !key
                .modifiers
                .intersects(KeyModifiers::CONTROL | KeyModifiers::ALT) =>
        {
            InputResult::Action(MenuAction::SetHiLo)
        }
        KeyCode::Char('|')
        ...
        {
            InputResult::Action(MenuAction::ToggleSplitter)
        }
        KeyCode::Char(';') if key.modifiers.is_empty() => {
            InputResult::Action(MenuAction::SideComment)
        }
        KeyCode::Char(':')
            if !key
                .modifiers
                .intersects(KeyModifiers::CONTROL | KeyModifiers::ALT) =>
        {
            InputResult::Action(MenuAction::LineComment)
        }
        KeyCode::Char('e') if key.modifiers.is_empty() => {
            InputResult::Action(MenuAction::SetExternalFile)
        }
        KeyCode::Enter if key.modifiers.is_empty() => {
            InputResult::Action(MenuAction::JumpToOperand)
        }
        KeyCode::Char('d') if key.modifiers.is_empty() => {
            InputResult::Action(MenuAction::NextImmediateFormat)
        }
