            ...
            categories: vec![
                MenuCategory {
                    ...
                    items: vec![
                        ...
                        MenuItem::new("Advanced Unpack...", None, Some(AppAction::UnpackDialog)),
                ...
                MenuCategory {
                    ...
                    items: vec![
                        ...
                        MenuItem::separator(),
                        MenuItem::new("Documentation", None, Some(AppAction::OpenDocumentation)),
                        MenuItem::new("Examples", None, Some(AppAction::OpenExamples)),
                        MenuItem::separator(),
