...
impl Theme {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            block_scope_fg: Solarized::VIOLET,
            block_code_bg: Solarized::BASE03,
            block_scope_bg: Solarized::BASE03,
    ...
    pub fn light() -> Self {
        Self {
            ...
            block_scope_bg: Solarized::BASE2,
            block_data_byte_fg: Solarized::CYAN,
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            block_scope_fg: Dracula::PURPLE,
            block_code_bg: Dracula::BACKGROUND,
            block_scope_bg: Dracula::BACKGROUND,
    ...
    pub fn gruvbox_dark() -> Self {
        Self {
            ...
            block_scope_fg: Gruvbox::PURPLE,
            block_code_bg: Gruvbox::BG0,
            block_scope_bg: Gruvbox::BG0,
    ...
    pub fn gruvbox_light() -> Self {
        Self {
            ...
            block_scope_bg: Gruvbox::BG1_LIGHT,
            block_data_byte_fg: Gruvbox::PURPLE,
    ...
    pub fn monokai() -> Self {
        Self {
            ...
            block_scope_fg: Monokai::PURPLE,
            block_code_bg: Monokai::BACKGROUND,
            block_scope_bg: Monokai::BACKGROUND,
    ...
    pub fn nord() -> Self {
        Self {
            ...
            block_scope_fg: Nord::NORD15,
            block_code_bg: Nord::NORD0,
            block_scope_bg: Nord::NORD0,
    ...
    pub fn catppuccin_mocha() -> Self {
        Self {
            ...
            block_scope_fg: CatppuccinMocha::LAVENDER,
            block_code_bg: CatppuccinMocha::BASE,
            block_scope_bg: CatppuccinMocha::BASE,
    ...
    pub fn catppuccin_latte() -> Self {
        Self {
            ...
            block_scope_fg: CatppuccinLatte::LAVENDER,
            block_code_bg: CatppuccinLatte::CRUST,
            block_scope_bg: CatppuccinLatte::CRUST,
