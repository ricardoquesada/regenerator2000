...
fn test_acme_lowercase_output() {
    ...
    labels.insert(
        ...
        vec![regenerator2000_core::state::Label {
            ...
            label_type: regenerator2000_core::state::LabelType::AbsoluteAddress,
        }],
    );
...
fn test_xref_formatting_with_dollar() {
    ...
    cross_refs.insert(
        regenerator2000_core::state::Addr(0x1000),
        vec![
            regenerator2000_core::state::Addr(0x2000),
            regenerator2000_core::state::Addr(0x3000),
        ],
    );
...
fn test_xref_count_configurable() {
    ...
    cross_refs.insert(
        ...
        vec![
            regenerator2000_core::state::Addr(0x2000),
            regenerator2000_core::state::Addr(0x2001),
            regenerator2000_core::state::Addr(0x2002),
            regenerator2000_core::state::Addr(0x2003),
            regenerator2000_core::state::Addr(0x2004),
            regenerator2000_core::state::Addr(0x2005),
        ],
    );
...
fn test_tass_label_interruption() {
    ...
    labels.insert(
        regenerator2000_core::state::Addr(0x1001),
        vec![Label {
            name: "MID".to_string(),
            kind: LabelKind::Auto,
...
fn test_screencode_threshold_per_formatter() {
    ...
    let text_lines: Vec<&regenerator2000_core::disassembler::DisassemblyLine> =
        lines.iter().filter(|l| l.mnemonic == ".text").collect();
...
fn test_target_address_population() {
    ...
    assert_eq!(
        ...
        Some(regenerator2000_core::state::Addr(0x1234))
    );
    ...
    assert_eq!(
        ...
        Some(regenerator2000_core::state::Addr(0x1009))
    );
...
fn test_target_address_specific_instructions() {
    ...
    assert_eq!(
        lines[0].target_address,
        Some(regenerator2000_core::state::Addr(0x2000))
    );
...
fn test_lohi_block() {
    ...
    labels.insert(
        regenerator2000_core::state::Addr(0xC000),
        vec![regenerator2000_core::state::Label {
...
fn test_lohi_internal_label_regression() {
    ...
    labels.insert(
        regenerator2000_core::state::Addr(0x1002), // Midpoint
        vec![regenerator2000_core::state::Label {
...
fn test_inverted_binary_format() {
    ...
    immediate_value_formats.insert(
        regenerator2000_core::state::Addr(0x1000),
        regenerator2000_core::state::ImmediateFormat::InvertedBinary,
    );
    immediate_value_formats.insert(
...
fn test_words_per_line() {
    ...
    let disassembler = Disassembler::new();
    let labels = BTreeMap::new();
    let origin = regenerator2000_core::state::Addr(0x2000);
