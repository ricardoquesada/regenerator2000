...
mod tests {
    ...
    fn test_disasm_selected() {
        ...
        assert_eq!(
            ...
            regenerator2000_core::state::Addr(0x1003)
        );
        assert_eq!(
            app_state.disassembly[3].address,
            regenerator2000_core::state::Addr(0x1004)
        ); // E8
        ...
        let req = McpRequest {
            ...
            params: json!({ "name": "r2000_read_selected", "arguments": { "view": "disasm" } }),
            response_sender: tx,
        };
    ...
    fn test_hexdump_selected() {
        ...
        let req = McpRequest {
            method: "tools/call".to_string(),
            params: json!({ "name": "r2000_read_selected", "arguments": { "view": "hexdump" } }),
            response_sender: tx,
        };
    ...
    fn test_jump_to_address() {
        ...
        assert_eq!(
            ...
            regenerator2000_tui::ui_state::ActivePane::Disassembly
        );
    }
}
