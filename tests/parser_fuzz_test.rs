...
use regenerator2000_core::parser::{crt, d64, t64, vice_vsf};
...
fn test_vice_labels_empty() {
    let result = regenerator2000_core::parser::vice_lbl::parse_vice_labels("");
    assert!(result.is_ok());
...
fn test_vice_labels_garbage() {
    ...
    let result = regenerator2000_core::parser::vice_lbl::parse_vice_labels(garbage);
    assert!(result.is_ok());
    assert!(result.unwrap().is_empty());
}
...
fn test_vice_labels_huge_address() {
    ...
    let result = regenerator2000_core::parser::vice_lbl::parse_vice_labels(content);
    assert!(result.is_ok());
