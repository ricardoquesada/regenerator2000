...
mod d64_malformed {
    use regenerator2000_core::parser::d64::{extract_file, parse_d64_directory};
    ...
    fn extract_file_with_too_small_image() {
        ...
        let dummy_entry = regenerator2000_core::parser::d64::D64FileEntry {
            filename: "TEST".to_string(),
            file_type: regenerator2000_core::parser::d64::FileType::PRG,
            track: 1,
            sector: 0,
            size_sectors: 1,
            disk_type: regenerator2000_core::parser::d64::DiskType::D64,
        };
    ...
    fn extract_file_sector_chain_loop_protection() {
        ...
        let entry = regenerator2000_core::parser::d64::D64FileEntry {
...
mod crt_malformed {
    use regenerator2000_core::parser::crt::{parse_crt, parse_crt_chips};
...
mod t64_malformed {
    use regenerator2000_core::parser::t64::{parse_t64, parse_t64_directory};
...
mod vsf_malformed {
    use regenerator2000_core::parser::vice_vsf::parse_vsf;
