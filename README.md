...
-   `--dump-platform-config-files <PATH>`: Dump all built-in system config files (`platform-*.toml`) to the specified directory and exit. Useful for inspecting or customizing platform definitions.
