...
* It should export the disassembled code to something that can be re-assembled with 64tass. But it should be flexible because in the future it should support other assemblers like ACME, cc65, etc.
